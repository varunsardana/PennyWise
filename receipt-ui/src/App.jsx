        ...
        <div className="mx-auto max-w-3xl px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Pill active={tab === "scan"} onClick={() => setTab("scan")}>
                Scan
              </Pill>
              <Pill active={tab === "history"} onClick={() => setTab("history")}>
                History
              </Pill>
              <Pill active={tab === "trends"} onClick={() => setTab("trends")}>
                Trends
              </Pill>
            </div>
          </div>
            ...
            <div className="space-y-5">
              ...
              {receipts.length ? (
                receipts.map((r) => (
                  <div
                    key={r.id}
                    className="rounded-2xl border border-gray-200 bg-white shadow-sm relative flex"
                  >
                    {/* Main content */}
              ...
              {insights ? (
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <StatCard
                      label="Total spend"
                      value={`$${Number(insights.total_spend).toFixed(2)}`}
                    />
                  </div>
